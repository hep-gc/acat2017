...
To access data through DynaFed a client makes a request for a file using WebDAV or HTTP.%WebDAV is the appropriate protocol for interacting with files and file systems, so
